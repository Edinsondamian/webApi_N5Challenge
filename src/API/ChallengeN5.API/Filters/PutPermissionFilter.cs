...
public class PutPermissionFilter : IAsyncAuthorizationFilter
{
    ...
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        PutPermissionsDto putPermissionsDto;
        try
        {
            putPermissionsDto = JsonConvert.DeserializeObject<PutPermissionsDto>(body);
        }
        catch (Exception)
        {
            bodyErrors.Add(ExceptionDetailResponseFactory.Create(
        ...
        if (string.IsNullOrEmpty(putPermissionsDto.PermissionTypeId))
        {
            bodyErrors.Add(ExceptionDetailResponseFactory.Create(
        ...
        bodyErrors = _patternAndRangesValidator.IsInvalid(
            "permissionTypeId",
            putPermissionsDto.PermissionTypeId,
